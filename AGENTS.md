...
- Frontend, dashboard → `app/javascript/dashboard/i18n/indica-facil/locale/<locale>/*.json`
- Frontend, survey → `app/javascript/survey/i18n/indica-facil/locale/<locale>.json` (one file, not a folder: it is a single small namespace)

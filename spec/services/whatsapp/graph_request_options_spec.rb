...
describe Whatsapp::GraphRequestOptions do
  ...
  # its own ceiling to decide, which is indicafacil-ai/chatwoot#589.
  ...
  it 'reads every call in the guarded files, so an empty result cannot pass as a clean one' do
    ...
    expected = {
      ...
      # indirection is what indicafacil-ai/chatwoot#605 needed, and collapsing five inspected calls into

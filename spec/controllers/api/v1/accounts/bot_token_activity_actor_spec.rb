...
# indicafacil-ai/chatwoot#456 was filed on exactly that reading and turned out to be wrong.
#
# What depends on it: the indicafacil.app agents runtime writes conversation labels with the INSTANCE ADMIN
# token today, which signs an automated verdict with a person's name (indica-facil/agents#493). Moving

...
# automations of every message in flight during a deploy (indicafacil-ai/chatwoot#660, #661).
#
...
RSpec.describe 'every announcement of a body-scoped event names its body' do # rubocop:disable RSpec/DescribeClass
  ...
  # That an arrival is outside all of this is a product decision (indicafacil-ai/chatwoot#648): an edit never

...
FE_TREES = [
  { upstream: 'app/javascript/dashboard/i18n/locale', fork: 'app/javascript/dashboard/i18n/indica-facil/locale', layout: :directory },
  { upstream: 'app/javascript/survey/i18n/locale', fork: 'app/javascript/survey/i18n/indica-facil/locale', layout: :file }
].freeze
...
class ForkTranslations
  ...
  def key_scopes(locale)
    ...
    scopes.merge('config/locales' => keys_in(Dir["config/locales/indica_facil*.#{locale}.yml"]))
  end
